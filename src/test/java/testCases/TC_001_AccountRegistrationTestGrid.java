...
import testBase.BaseClassGrid;
import testBase.BaseClassGroupExtentReport;

public class TC_001_AccountRegistrationTestGrid extends BaseClassGrid {
	@Test(groups= {"Regression","Master"}) //Step8 groups added
	public void test_account_Registration() throws InterruptedException
	{		
		logger.info("Starting TC_001_AccountRegistrationTestGrid");
		try {
